...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/modal` | `/(tabs)/events` | `/events` | `/(tabs)/friends` | `/friends` | `/(tabs)/` | `/(tabs)` | `/(tabs)/profile` | `/profile` | `/suggestPlace/components/imagePicker` | `/suggestPlace/components/selectCity` | `/suggestPlace/`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/place/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/place/[id]`;
